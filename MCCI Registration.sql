...
--
-- Database: `igot_mcciregistration`
--
CREATE DATABASE IF NOT EXISTS `igot_mcciregistration` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `igot_mcciregistration`;
